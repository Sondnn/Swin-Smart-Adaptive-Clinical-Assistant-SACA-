...
fun GenderQuestionScreen(
    ...
    val options = TriageFormViewModel.GenderOption.entries.map {
        FormQuestionOption(
            id = it.value,
    ...
    FormQuestionScaffold(
        ...
        modifier = modifier,
        voiceQuestionId = TriageFormViewModel.TriageQuestionId.GENDER.value,
        ...
        onTranscribeAudio = { audioFile ->
            triageFormViewModel.transcribeAnswer(
                questionId = TriageFormViewModel.TriageQuestionId.GENDER.value,
                audioFile = audioFile,
