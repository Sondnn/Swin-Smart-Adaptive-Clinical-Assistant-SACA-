...
@Composable
fun SymptomsBeforeQuestionScreen(
    onBackClick: () -> Unit,
    onCancelClick: () -> Unit,
    ...
    val options = TriageFormViewModel.SymptomsBeforeOption.entries.map {
        FormQuestionOption(
            id = it.value,
    ...
    FormQuestionScaffold(
        ...
        questionResId = R.string.triage_form_symptoms_before_question_speak,
        ...
        options = options,
        selectedOptionId = triageFormViewModel.selectedSymptomsBeforeOptionId,
        currentStep = 6,
        totalSteps = 8,
        onBackClick = onBackClick,
        onOptionClick = triageFormViewModel::onSymptomsBeforeOptionSelected,
        onCancelClick = onCancelClick,
        onContinueClick = onContinueClick,
        modifier = modifier,
        voiceQuestionId = TriageFormViewModel.TriageQuestionId.SYMPTOMS_BEFORE.value,
        ...
        onTranscribeAudio = { audioFile ->
            triageFormViewModel.transcribeAnswer(
                questionId = TriageFormViewModel.TriageQuestionId.SYMPTOMS_BEFORE.value,
                audioFile = audioFile,
